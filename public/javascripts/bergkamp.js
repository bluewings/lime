...
(function () {
    ...
    var app = angular.module('bergkamp', [
        'ngRoute',
        'ngResource',
        'ngSanitize',
        //'ngAnimate',
    ...
    app.constant('CONFIG', {
        ...
        URI: {
            MAIN: '/bergkamp',
            BOARD_VIEW: '/bergkamp/board/:boardId/view',
            BOARD_CREATE: '/bergkamp/board/edit',
            BOARD_MODIFY: '/bergkamp/board/:boardId/edit',
            NOTE_VIEW: '/bergkamp/board/:boardId/note/:_id/view',
            NOTE_CREATE: '/bergkamp/board/:boardId/note/edit',
            NOTE_MODIFY: '/bergkamp/board/:boardId/note/:_id/edit'
        }
    });
    ...
    app.constant('ERROR', {
        USER_NOT_FOUND: {
            TYPE: 'user_not_found',
            URI: '/bergkamp/error/userNotFound/:userId'
        }
    });
        ...
        function ($locationProvider, $routeProvider, $compileProvider, CONFIG, ERROR) {
            ...
            $routeProvider
                .when(CONFIG.URI.MAIN, {
                    templateUrl: '/templates/bergkamp-main',
                    controller: 'bergkampCtrl_main'
                })
                .when(CONFIG.URI.BOARD_VIEW, {
                    templateUrl: '/templates/bergkamp-board-view',
                    controller: 'bergkampCtrl_boardView'
                })
                .when(CONFIG.URI.BOARD_CREATE, {
                    templateUrl: '/templates/bergkamp-board-edit',
                    controller: 'bergkampCtrl_boardEdit'
                })
                ...
                .when(CONFIG.URI.NOTE_VIEW, {
                    templateUrl: '/templates/bergkamp-note-view',
                    controller: 'bergkampCtrl_noteView'
                })
                .when(CONFIG.URI.NOTE_CREATE, {
                    templateUrl: '/templates/bergkamp-note-edit',
                    controller: 'bergkampCtrl_noteEdit'
                })
    ...
    app.controller('bergkampCtrl_main', [
    ...
    app.controller('bergkampCtrl_boardView', [
    ...
    app.controller('bergkampCtrl_boardEdit', [
    ...
    app.controller('bergkampCtrl_noteView', [
    ...
    app.controller('bergkampCtrl_noteEdit', [
    ...
    angular.element(document).ready(function () {
        ...
        angular.bootstrap(document, ['bergkamp']);
    });
